...
def main_page():
    ...
    <a href="/pass_gen">А тут ты можешь сгенерировать случайный пароль!</a>
    '''
@app.route("/random_fact")
def technological_dependencies():
    return f'<p>{random.choice(facts_list)}</p>'

@app.route("/pass_gen")
def pass_gen():
    pas = ''
    pas_symb = '1234567890abcdefghigklmnopqrstuvyxwzABCDEFGHIGKLMNOPQRSTUVYXWZ'
    for i in range(16):
        pas = pas + random.choice(pas_symb)
    return f'<p>Привет, твой случайный пароль: {pas}</p>'
